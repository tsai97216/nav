const CACHE_NAME = "chi-nav-v2.2.22";
const CORE_ASSETS = ["./", "./index.html", "./css/style.css", "./css/theme.css?v=2.2.22", "./js/data.js?v=2.2.22", "./js/update.js?v=2.2.22", "./js/app.js?v=2.2.22", "./data/data.json", "./data/version.json", "./manifest.json", "./css/update.css?v=2.2.22", "./css/card-tooltip.css?v=2.2.22", "./js/theme.js?v=2.2.22", "./js/card-tooltip.js?v=2.2.22"];
