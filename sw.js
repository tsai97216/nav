const CACHE_NAME = "chi-nav-v2.2.24";
const CORE_ASSETS = ["./", "./index.html", "./css/style.css", "./css/theme.css?v=2.2.24", "./js/data.js?v=2.2.24", "./js/storage.js?v=2.2.24", "./js/update.js?v=2.2.24", "./js/search.js?v=2.2.24", "./js/app.js?v=2.2.24", "./data/data.json", "./data/version.json", "./manifest.json", "./css/update.css?v=2.2.24", "./css/card-tooltip.css?v=2.2.24", "./js/theme.js?v=2.2.24", "./js/card-tooltip.js?v=2.2.24"];
