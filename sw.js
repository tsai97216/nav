const CACHE_NAME = "chi-nav-v2.8.6";
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./css/style.css?v=2.8.6",
  "./css/responsive.css?v=2.8.6",
  "./css/theme.css?v=2.8.6",
  "./css/update.css?v=2.8.6",
  "./css/card-tooltip.css?v=2.8.6",
  "./css/enhancements.css?v=2.8.6",
  "./css/loading.css?v=2.8.6",
  "./css/category-page.css?v=2.8.6",
  "./js/data.js?v=2.8.6",
  "./js/storage.js?v=2.8.6",
  "./js/update.js?v=2.8.6",
  "./js/search.js?v=2.8.6",
  "./js/navigation.js?v=2.8.6",
  "./js/render.js?v=2.8.6",
  "./js/app.js?v=2.8.6",
  "./js/theme.js?v=2.8.6",
  "./js/card-tooltip.js?v=2.8.6",
  "./js/bootstrap.js?v=2.8.6",
  "./data/data.json?v=2.8.6",
  "./data/version.json",
  "./manifest.json?v=2.8.6",
...
async function networkFirst(request) {
  try {
    ...
    if (path.endsWith("/data/data.json")) {
      const keys = [
        request,
        new Request(new URL("./data/data.json?v=2.8.6", self.location.origin)),
