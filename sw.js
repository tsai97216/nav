const CACHE_NAME = "chi-nav-v2.2.30";
const CORE_ASSETS = ["./", "./index.html", "./css/style.css?v=2.2.30", "./css/theme.css?v=2.2.30", "./js/data.js?v=2.2.30", "./js/storage.js?v=2.2.30", "./js/update.js?v=2.2.30", "./js/search.js?v=2.2.30", "./js/navigation.js?v=2.2.30", "./js/render.js?v=2.2.30", "./js/app.js?v=2.2.30", "./data/data.json", "./data/version.json", "./manifest.json", "./css/update.css?v=2.2.30", "./css/card-tooltip.css?v=2.2.30", "./js/theme.js?v=2.2.30", "./js/card-tooltip.js?v=2.2.30"];
