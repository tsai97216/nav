...
const CORE_ASSETS = ["./", "./index.html", "./style.css", "./theme.css?v=2.2.19", "./app.js?v=2.2.19", "./data.json", "./version.json", "./manifest.json", "./update.css?v=2.2.19", "./card-tooltip.css?v=2.2.19", "./theme.js?v=2.2.19", "./card-tooltip.js?v=2.2.19"];
