const CACHE_NAME = "chi-nav-v2.3.6";
const CORE_ASSETS = ["./", "./index.html", "./css/style.css?v=2.3.6", "./css/responsive.css?v=2.3.6", "./css/theme.css?v=2.3.6", "./js/data.js?v=2.3.6", "./js/storage.js?v=2.3.6", "./js/update.js?v=2.3.6", "./js/search.js?v=2.3.6", "./js/navigation.js?v=2.3.6", "./js/render.js?v=2.3.6", "./js/app.js?v=2.3.6", "./data/data.json", "./data/version.json", "./manifest.json", "./css/update.css?v=2.3.6", "./css/card-tooltip.css?v=2.3.6", "./css/enhancements.css?v=2.3.6", "./js/theme.js?v=2.3.6", "./js/card-tooltip.js?v=2.3.6", "./js/bootstrap.js?v=2.3.6"];
